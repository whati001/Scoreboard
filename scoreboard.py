...
#15-10-2016: mofify resolution for 800x480
################################################################################
#import modules
from tkinter import *
import os
...
class scoreboard_main_class():
	...
	def __init__(self, *args, **kwargs):
		...
		#Reset all LEDs
		self.class_smbus.write_out(7, 0)
		self.class_smbus.write_out(6, 0)
		self.class_smbus.write_out(5, 0)
		self.class_smbus.write_out(4, 0)
		self.class_smbus.write_out(3, 0)
		self.class_smbus.write_out(2, 0)
		self.class_smbus.write_out(1, 0)
		self.class_smbus.write_out(0, 0)
		...
		###Headerinfo###
		self.Header01 = Label(self.scoreboard_master, text='Anzeigetapfel', font='Arial 20 bold')
		self.Header01.pack()
		self.Header01.place(relx=0.5, y=20, anchor=CENTER)
			
		self.Header02 = Label(self.scoreboard_master, text='Bitte Einstellungen vornehmen und Betriebsart wählen:', font='Arial 16 bold')
		self.Header02.pack()
		self.Header02.place(relx=0.5, y=50, anchor=CENTER)

		if self.recovery_enable != 'true':		
			###Button### 
			#start the different operation modes
			#stopwatch_master Button 
			self.stopwatch_master = Button(self.scoreboard_master, text='Stoppuhr', font='Arial 16 bold', state=DISABLED, command=lambda: self.new_window(stopwatch_master_class))
			self.stopwatch_master.pack()
			self.stopwatch_master.place(relx=0.8, rely=0.85, height=50, width=150, anchor=CENTER)
			
			#countdown_master Button
			self.countdown_master = Button(self.scoreboard_master, text='Countdown', font='Arial 16 bold', state=DISABLED, command=lambda: self.new_window(countdown_master_class))
			self.countdown_master.pack()
			self.countdown_master.place(relx=0.2, rely=0.85, height=50, width=150, anchor=CENTER)
	...
	def initialsetup(self):
		...
		self.ChangeSystemTime = Label(self.scoreboard_master, text='System Datum/Zeit:', font='Arial 18 bold')
		self.ChangeSystemTime.pack()
		self.ChangeSystemTime.place(relx=0.05, rely=0.25, anchor=W)
		
		#Day Label	
		self.day=Label(self.scoreboard_master, textvariable=self.var_scoreboard_set[0], font='Arial 16 bold')
		self.day.pack()
		self.day.place(relx=0.40, rely=0.25, anchor=CENTER)

		#Day Label Info
		self.day_info=Label(self.scoreboard_master, text='Tag', font='Arial 12 bold')
		self.day_info.pack
		self.day_info.place(relx=0.40, rely=0.25, x=0, y=-25, anchor=CENTER)			
		
		#increment the day
		self.day_plus=Button(self.scoreboard_master, text='+', font='Arial 16 bold', command=lambda: self.scoreboard_initial_set('+',0))
		self.day_plus.pack()
		self.day_plus.place(relx=0.4, rely=0.25, y=+15, height=30, width=30, anchor=NE)
		
		#decrement the day
		self.day_minus=Button(self.scoreboard_master, text='-', font='Arial 16 bold', command=lambda: self.scoreboard_initial_set('-',0))
		self.day_minus.pack()
		self.day_minus.place(relx=0.4, rely=0.25, y=+15, height=30, width=30, anchor=NW)
		
		#Day Month Delimiter Label	
		self.day_month_delimiter=Label(self.scoreboard_master, text='.', font='Arial 16 bold')
		self.day_month_delimiter.pack()
		self.day_month_delimiter.place(relx=0.4, rely=0.25, x=+30, anchor=CENTER)

		#Month Label	
		self.month=Label(self.scoreboard_master, textvariable=self.var_scoreboard_set[1], font='Arial 16 bold')
		self.month.pack()
		self.month.place(relx=0.4, rely=0.25, x=+60, anchor=CENTER)			
		
		#Month Label Info
		self.month_info=Label(self.scoreboard_master, text='Monat', font='Arial 12 bold')
		self.month_info.pack()
		self.month_info.place(relx=0.4, rely=0.25, x=60, y=-25, anchor=CENTER)

		#increment the month
		self.month_plus=Button(self.scoreboard_master, text='+', font='Arial 16 bold', command=lambda: self.scoreboard_initial_set('+',1))
		self.month_plus.pack()
		self.month_plus.place(relx=0.4, rely=0.25, x=60, y=+15, height=30, width=30, anchor=NE)
		
		#decrement the month
		self.month_minus=Button(self.scoreboard_master, text='-', font='Arial 16 bold', command=lambda: self.scoreboard_initial_set('-',1))
		self.month_minus.pack()
		self.month_minus.place(relx=0.4, rely=0.25, x=60, y=+15, height=30, width=30, anchor=NW)

		#Day Month Delimiter Label	
		self.month_year_delimiter=Label(self.scoreboard_master, text='.', font='Arial 16 bold')
		self.month_year_delimiter.pack()
		self.month_year_delimiter.place(relx=0.4, rely=0.25, x=90, anchor=CENTER)

		#Year Label	
		self.year=Label(self.scoreboard_master, textvariable=self.var_scoreboard_set[2], font='Arial 16 bold')
		self.year.pack()
		self.year.place(relx=0.4, rely=0.25, x=+120, anchor=CENTER)			
		
		#year Label Info
		self.year_info=Label(self.scoreboard_master, text='Jahr', font='Arial 12 bold')
		self.year_info.pack()
		self.year_info.place(relx=0.4, rely=0.25, x=120, y=-25, anchor=CENTER)

		#increment the year
		self.year_plus=Button(self.scoreboard_master, text='+', font='Arial 16 bold', command=lambda: self.scoreboard_initial_set('+',2))
		self.year_plus.pack()
		self.year_plus.place(relx=0.4, rely=0.25, x=120, y=+15, height=30, width=30, anchor=NE)
		
		#decrement the year
		self.year_minus=Button(self.scoreboard_master, text='-', font='Arial 16 bold', command=lambda: self.scoreboard_initial_set('-',2))
		self.year_minus.pack()
		self.year_minus.place(relx=0.4, rely=0.25, x=120, y=+15, height=30, width=30, anchor=NW)

		#Hour Label	
		self.hour=Label(self.scoreboard_master, textvariable=self.var_scoreboard_set[3], font='Arial 16 bold')
		self.hour.pack()
		self.hour.place(relx=0.4, rely=0.25, x=+300, anchor=CENTER)			
		
		#hour Label Info
		self.hour_info=Label(self.scoreboard_master, text='Stunde', font='Arial 12 bold')
		self.hour_info.pack()
		self.hour_info.place(relx=0.4, rely=0.25, x=300, y=-25, anchor=CENTER)

		#increment the hour
		self.hour_plus=Button(self.scoreboard_master, text='+', font='Arial 16 bold', command=lambda: self.scoreboard_initial_set('+',3))
		self.hour_plus.pack()
		self.hour_plus.place(relx=0.4, rely=0.25, x=300, y=+15, height=30, width=30, anchor=NE)
		
		#decrement the hour
		self.hour_minus=Button(self.scoreboard_master, text='-', font='Arial 16 bold', command=lambda: self.scoreboard_initial_set('-',3))
		self.hour_minus.pack()
		self.hour_minus.place(relx=0.4, rely=0.25, x=300, y=+15, height=30, width=30, anchor=NW)

		#Hour Minute Delimiter Label	
		self.hour_minute_delimiter=Label(self.scoreboard_master, text=':', font='Arial 16 bold')
		self.hour_minute_delimiter.pack()
		self.hour_minute_delimiter.place(relx=0.4, rely=0.25, x=+330, anchor=CENTER)		

		#Minute Label	
		self.minute=Label(self.scoreboard_master, textvariable=self.var_scoreboard_set[4], font='Arial 16 bold')
		self.minute.pack()
		self.minute.place(relx=0.4, rely=0.25, x=+360, anchor=CENTER)			
		
		#minute Label Info
		self.minute_info=Label(self.scoreboard_master, text='Minuten', font='Arial 12 bold')
		self.minute_info.pack()
		self.minute_info.place(relx=0.4, rely=0.25, x=360, y=-25, anchor=CENTER)

		#increment the minute
		self.minute_plus=Button(self.scoreboard_master, text='+', font='Arial 16 bold', command=lambda: self.scoreboard_initial_set('+',4))
		self.minute_plus.pack()
		self.minute_plus.place(relx=0.4, rely=0.25, x=360, y=+15, height=30, width=30, anchor=NE)
		
		#decrement the minute
		self.minute_minus=Button(self.scoreboard_master, text='-', font='Arial 16 bold', command=lambda: self.scoreboard_initial_set('-',4))
		self.minute_minus.pack()
		self.minute_minus.place(relx=0.4, rely=0.25, x=360, y=+15, height=30, width=30, anchor=NW)

		if self.recovery_enable != 'true':
			###Setup Interval###	
			#Draw Label interval
			self.interval = Label(self.scoreboard_master, text='Intervalzeit:', font='Arial 18 bold')
			self.interval.pack()
			self.interval.place(relx=0.05, rely=0.45, anchor=W)
			
			#Minute Label	
			self.interval_minute=Label(self.scoreboard_master, textvariable=self.var_scoreboard_set[5], font='Arial 16 bold')
			self.interval_minute.pack()
			self.interval_minute.place(relx=0.4, rely=0.45, anchor=CENTER)
	
			#Minute Label Info
			self.interval_minute_info=Label(self.scoreboard_master, text='Minute', font='Arial 12 bold')
			self.interval_minute_info.pack()
			self.interval_minute_info.place(relx=0.4, rely=0.45, x=0, y=-25, anchor=CENTER)			
			
			#increment the minute
			self.interval_minute_plus=Button(self.scoreboard_master, text='+', font='Arial 16 bold', command=lambda: self.scoreboard_initial_set('+',5))
			self.interval_minute_plus.pack()
			self.interval_minute_plus.place(relx=0.4, rely=0.45, y=+15, height=30, width=30, anchor=NE)
			
			#decrement the minute
			self.interval_minute_minus=Button(self.scoreboard_master, text='-', font='Arial 16 bold', command=lambda: self.scoreboard_initial_set('-',5))
			self.interval_minute_minus.pack()
			self.interval_minute_minus.place(relx=0.4, rely=0.45, y=+15, height=30, width=30, anchor=NW)
			
			#Interval Minute Second Delimiter	
			self.interval_minute_second_delimiter=Label(self.scoreboard_master, text=':', font='Arial 16 bold')
			self.interval_minute_second_delimiter.pack()
			self.interval_minute_second_delimiter.place(relx=0.4, rely=0.45, x=+30, anchor=CENTER)
	
			#Second Label	
			self.interval_second=Label(self.scoreboard_master, textvariable=self.var_scoreboard_set[6], font='Arial 16 bold')
			self.interval_second.pack()
			self.interval_second.place(relx=0.4, rely=0.45, x=+60, anchor=CENTER)			
			
			#Second Label Info
			self.interval_second_info=Label(self.scoreboard_master, text='Sekunden', font='Arial 12 bold')
			self.interval_second_info.pack()
			self.interval_second_info.place(relx=0.4, rely=0.45, x=60, y=-25, anchor=CENTER)
	
			#increment the second
			self.interval_second_plus=Button(self.scoreboard_master, text='+', font='Arial 16 bold', command=lambda: self.scoreboard_initial_set('+',6))
			self.interval_second_plus.pack()
			self.interval_second_plus.place(relx=0.4, rely=0.45, x=60, y=+15, height=30, width=30, anchor=NE)
			
			#decrement the second
			self.interval_second_plusminus=Button(self.scoreboard_master, text='-', font='Arial 16 bold', command=lambda: self.scoreboard_initial_set('-',6))
			self.interval_second_plusminus.pack()
			self.interval_second_plusminus.place(relx=0.4, rely=0.45, x=60, y=+15, height=30, width=30, anchor=NW)
		

			###Setup Logging###	
			#Draw Label Logging
			self.logging = Label(self.scoreboard_master, text='Logging:', font='Arial 16 bold')
			self.logging.pack()
			self.logging.place(relx=0.04, rely=0.65, anchor=W)
			
			#Logging value
			self.logging=Label(self.scoreboard_master, textvariable=self.var_scoreboard_set[7], font='Arial 16 bold')
			self.logging.pack()
			self.logging.place(relx=0.4, rely=0.65, anchor=CENTER)
	
			#Logging value Info
			self.logging_info=Label(self.scoreboard_master, text='Ja/Nein', font='Arial 12 bold')
			self.logging_info.pack()
			self.logging_info.place(relx=0.4, rely=0.65, y=-25, anchor=CENTER)			
			...
			self.logging_enable.place(relx=0.4, rely=0.65, y=+15, height=30, width=30, anchor=NE)
			...
			self.logging_disenable.place(relx=0.4, rely=0.65, y=+15, height=30, width=30, anchor=NW)

		#Save Settings Button 
		self.initial_save = Button(self.scoreboard_master, text='Speichern', font='Arial 16 bold', command=self.scoreboard_initial_save)
		self.initial_save.pack()
		self.initial_save.place(relx=0.5, rely=0.85, height=50, width=150, anchor=CENTER)
...
class logging_setup_class():
	...
	def __init__(self, scoreboard_master):
		...
		self.var_logging_setup_set[0].set('LOCAL: Excel nach,\n/opt/scoreboard/ExcelFiles\n\nUSB: Excel via USB.')
		...
		self.logging_setup.takefocus=True
	        ...
	        ###Headerinfo###
		self.Header01=Label(self.logging_setup, text='Logging Setup', font='Arial 20 bold')
		self.Header01.pack()
		...
		#Draw Label Logging
		self.loggingPathInfo = Label(self.logging_setup, text='Excel Path:', font='Arial 18 bold')
		self.loggingPathInfo.pack()
		self.loggingPathInfo.place(relx=0.05, rely=0.28, anchor=W)
		
		#ExcelPath Value
		self.logging_value=Label(self.logging_setup, textvariable=self.var_logging_setup_set[1], font='Arial 12 bold')
		self.logging_value.pack()
		self.logging_value.place(relx=0.33, rely=0.28, anchor=CENTER)

		#ExcelPath Info
		self.loggingPathInfo02=Label(self.logging_setup, text='Excel Path waehlen', font='Arial 12 bold')
		self.loggingPathInfo02.pack()
		self.loggingPathInfo02.place(relx=0.33, rely=0.28, x=0, y=-25, anchor=CENTER)			
		
		#USB ExcelPath
		self.logging_enable=Button(self.logging_setup, text='<', font='Arial 16 bold', command=lambda: self.loggingsetup_set('+',1))
		self.logging_enable.pack()
		self.logging_enable.place(relx=0.33, rely=0.28, y=+15, height=30, width=30, anchor=NE)
		
		#Local ExcelPath
		self.logging_disenable=Button(self.logging_setup, text='>', font='Arial 16 bold', command=lambda: self.loggingsetup_set('-',1))
		self.logging_disenable.pack()
		self.logging_disenable.place(relx=0.33, rely=0.28, y=+15, height=30, width=30, anchor=NW)
		...
		self.timedeltaPathInfo = Label(self.logging_setup, text='Zeit korrigur:', font='Arial 18 bold')
		self.timedeltaPathInfo.pack()
		self.timedeltaPathInfo.place(relx=0.05, rely=0.56, anchor=W)

		#Timedelta value
		self.timedelta=Label(self.logging_setup, textvariable=self.var_logging_setup_set[10], font='Arial 16 bold')
		self.timedelta.pack()
		...
		self.timedelta_info.place(relx=0.33, rely=0.56, x=0, y=-25, anchor=CENTER)			
		...
		self.timedelta_enable.place(relx=0.33, rely=0.56, y=+15, height=30, width=30, anchor=NE)
		...
		self.timedelta_disenable.place(relx=0.33, rely=0.56, y=+15, height=30, width=30, anchor=NW)
	...
	def config_excel_sheet(self):
		...
		if len(pytrack.groups) == 4:
			...
			self.loggingPathInfo03.config(font='Arial 16 bold')
			...
			#Draw Label Gamemode
			self.logging_gamemode_info = Label(self.logging_setup, text='Kreuzspiele:', font='Arial 18 bold')
			self.logging_gamemode_info.pack()
			self.logging_gamemode_info.place(relx=0.55, rely=0.28, anchor=W)
			
			#Gamemode
			self.logging_gamemode=Label(self.logging_setup, textvariable=self.var_logging_setup_set[9], font='Arial 16 bold')
			self.logging_gamemode.pack()
			self.logging_gamemode.place(relx=0.83, rely=0.28, anchor=CENTER)
	
			#Gamemode value Inf
			self.logging_gamemode_info02=Label(self.logging_setup, text='Kreuzspiele aktivieren', font='Arial 12 bold')
			self.logging_gamemode_info02.pack()
			self.logging_gamemode_info02.place(relx=0.83, rely=0.28, x=0, y=-20, anchor=CENTER)			
			
			#enabel mixmode
			self.logging_enable=Button(self.logging_setup, text='<', font='Arial 16 bold', command=lambda: self.loggingsetup_set('+',9))
			self.logging_enable.pack()
			self.logging_enable.place(relx=0.83, rely=0.28, y=+15, height=30, width=30, anchor=NE)
			
			#enable non-mixmode
			self.logging_disenable=Button(self.logging_setup, text='>', font='Arial 16 bold', command=lambda: self.loggingsetup_set('-',9))
			self.logging_disenable.pack()
			self.logging_disenable.place(relx=0.83, rely=0.28, y=+15, height=30, width=30, anchor=NW)

		###Setup Starttime###	
		#Draw Label starttime
		self.starttime_group = Label(self.logging_setup, text='Startzeit:', font='Arial 18 bold')
		self.starttime_group.pack()
		self.starttime_group.place(relx=0.05, rely=0.46, anchor=W)
		
		#Minute Label	
		self.starttime_group_minute=Label(self.logging_setup, textvariable=str(self.var_logging_setup_set[2]).zfill(2), font='Arial 16 bold')
		self.starttime_group_minute.pack()
		self.starttime_group_minute.place(relx=0.33, rely=0.46, anchor=CENTER)

		#Minute Label Info
		self.starttime_group_minute_info=Label(self.logging_setup, text='Minute', font='Arial 12 bold')
		self.starttime_group_minute_info.pack()
		self.starttime_group_minute_info.place(relx=0.33, rely=0.46,y=-20, anchor=CENTER)			
		
		#increment the minute
		self.starttime_group_minute_plus=Button(self.logging_setup, text='+', font='Arial 16 bold', command=lambda: self.loggingsetup_set('+',2))
		self.starttime_group_minute_plus.pack()
		self.starttime_group_minute_plus.place(relx=0.33, rely=0.46, y=+15, height=30, width=30, anchor=NE)
		
		#decrement the minute
		self.starttime_group_minute=Button(self.logging_setup, text='-', font='Arial 16 bold', command=lambda: self.loggingsetup_set('-',2))
		self.starttime_group_minute.pack()
		self.starttime_group_minute.place(relx=0.33, rely=0.46, y=+15, height=30, width=30, anchor=NW)
		
		#starttime Minute Second Delimiter	
		self.starttime_group_minute_second_delimiter=Label(self.logging_setup, text=':', font='Arial 16 bold')
		self.starttime_group_minute_second_delimiter.pack()
		self.starttime_group_minute_second_delimiter.place(relx=0.33, rely=0.46, x=+30, anchor=CENTER)

		#Second Label	
		self.starttime_group_second=Label(self.logging_setup, textvariable=str(self.var_logging_setup_set[3]).zfill(2), font='Arial 16 bold')
		self.starttime_group_second.pack()
		self.starttime_group_second.place(relx=0.33, rely=0.46, x=+60, anchor=CENTER)			
		
		#Second Label Info
		self.starttime_group_second_info=Label(self.logging_setup, text='Sekunden', font='Arial 12 bold')
		self.starttime_group_second_info.pack()
		self.starttime_group_second_info.place(relx=0.33, rely=0.46, x=60, y=-20, anchor=CENTER)

		#increment the second
		self.starttime_group_second_plus=Button(self.logging_setup, text='+', font='Arial 16 bold', command=lambda: self.loggingsetup_set('+',3))
		self.starttime_group_second_plus.pack()
		self.starttime_group_second_plus.place(relx=0.33, rely=0.46, x=60, y=+15, height=30, width=30, anchor=NE)
		
		#decrement the second
		self.starttime_group_second_minus=Button(self.logging_setup, text='-', font='Arial 16 bold', command=lambda: self.loggingsetup_set('-',3))
		self.starttime_group_second_minus.pack()
		self.starttime_group_second_minus.place(relx=0.33, rely=0.46, x=60, y=+15, height=30, width=30, anchor=NW)

		###Choose Gamemode###	
		#Draw Label Gamemode
		self.logging_gamemode_info = Label(self.logging_setup, text='Spielmode:', font='Arial 18 bold')
		self.logging_gamemode_info.pack()
		self.logging_gamemode_info.place(relx=0.55, rely=0.46, anchor=W)
		
		#Gamemode
		self.logging_gamemode=Label(self.logging_setup, textvariable=self.var_logging_setup_set[4], font='Arial 16 bold')
		self.logging_gamemode.pack()
		...
		self.logging_gamemode_info02.pack()
		self.logging_gamemode_info02.place(relx=0.83, rely=0.46, y=-20, anchor=CENTER)			
		...
		self.logging_enable_gamemode.place(relx=0.83, rely=0.46, y=+15, height=40, width=40, anchor=NE)
		...
		self.logging_disenable_gamemode.place(relx=0.83, rely=0.46, y=+15, height=40, width=40, anchor=NW)

		###Setup Playtime Group###	
		#Draw Label Playtime Group
		self.playtime_group_info = Label(self.logging_setup, text='Spielzeit Gruppe:', font='Arial 18 bold')
		self.playtime_group_info.pack()
		self.playtime_group_info.place(relx=0.05, rely=0.64, anchor=W)
		
		#Minute Label	
		self.starttime_group_minute=Label(self.logging_setup, textvariable=str(self.var_logging_setup_set[5]).zfill(2), font='Arial 16 bold')
		self.starttime_group_minute.pack()
		self.starttime_group_minute.place(relx=0.33, rely=0.64, anchor=CENTER)

		#Minute Label Info
		self.starttime_group_minute_info02=Label(self.logging_setup, text='Minute', font='Arial 12 bold')
		self.starttime_group_minute_info02.pack()
		self.starttime_group_minute_info02.place(relx=0.33, rely=0.64, y=-20, anchor=CENTER)			
		
		#increment the minute
		self.starttime_group_minute_plus=Button(self.logging_setup, text='+', font='Arial 16 bold', command=lambda: self.loggingsetup_set('+',5))
		self.starttime_group_minute_plus.pack()
		self.starttime_group_minute_plus.place(relx=0.33, rely=0.64, y=+15, height=30, width=30, anchor=NE)
		
		#decrement the minute
		self.starttime_group_minute_minus=Button(self.logging_setup, text='-', font='Arial 16 bold', command=lambda: self.loggingsetup_set('-',5))
		self.starttime_group_minute_minus.pack()
		self.starttime_group_minute_minus.place(relx=0.33, rely=0.64, y=+15, height=30, width=30, anchor=NW)
		
		###Setup Breaktime Group###	
		#Draw Label starttime
		self.breacktime_group_info = Label(self.logging_setup, text='Pausen Gruppe:', font='Arial 18 bold')
		self.breacktime_group_info.pack()
		self.breacktime_group_info.place(relx=0.55, rely=0.64, anchor=W)
		
		#Minute Label	
		self.breacktime_group_minute=Label(self.logging_setup, textvariable=str(self.var_logging_setup_set[6]).zfill(2), font='Arial 16 bold')
		self.breacktime_group_minute.pack()
		self.breacktime_group_minute.place(relx=0.83, rely=0.64, anchor=CENTER)

		#Minute Label Info
		self.breacktime_group_minute_info=Label(self.logging_setup, text='Minute', font='Arial 12 bold')
		self.breacktime_group_minute_info.pack()
		self.breacktime_group_minute_info.place(relx=0.83, rely=0.64,y=-20, anchor=CENTER)			
		
		#increment the minute
		self.breacktime_group_minute_plus=Button(self.logging_setup, text='+', font='Arial 16 bold', command=lambda: self.loggingsetup_set('+',6))
		self.breacktime_group_minute_plus.pack()
		self.breacktime_group_minute_plus.place(relx=0.83, rely=0.64, y=+15, height=30, width=30, anchor=NE)
		
		#decrement the minute
		self.breacktime_group_minute_minus=Button(self.logging_setup, text='-', font='Arial 16 bold', command=lambda: self.loggingsetup_set('-',6))
		self.breacktime_group_minute_minus.pack()
		self.breacktime_group_minute_minus.place(relx=0.83, rely=0.64, y=+15, height=30, width=30, anchor=NW)

		###Setup Playtime Crisscross###	
		#Draw Label starttime
		self.starttime_cc_info = Label(self.logging_setup, text='Spielzeit Kreuz.:', font='Arial 18 bold')
		self.starttime_cc_info.pack()
		self.starttime_cc_info.place(relx=0.05, rely=0.82, anchor=W)
		
		#Minute Label	
		self.starttime_cc_minute=Label(self.logging_setup, textvariable=str(self.var_logging_setup_set[7]).zfill(2), font='Arial 16 bold')
		self.starttime_cc_minute.pack()
		self.starttime_cc_minute.place(relx=0.33, rely=0.82, anchor=CENTER)

		#Minute Label Info
		self.starttime_cc_minute_info=Label(self.logging_setup, text='Minute', font='Arial 12 bold')
		self.starttime_cc_minute_info.pack()
		self.starttime_cc_minute_info.place(relx=0.33, rely=0.82, y=-20, anchor=CENTER)			
		
		#increment the minute
		self.starttime_cc_minute_plus=Button(self.logging_setup, text='+', font='Arial 16 bold', command=lambda: self.loggingsetup_set('+',7))
		self.starttime_cc_minute_plus.pack()
		self.starttime_cc_minute_plus.place(relx=0.33, rely=0.82, y=+15, height=30, width=30, anchor=NE)
		
		#decrement the minute
		self.starttime_cc_minute_minus=Button(self.logging_setup, text='-', font='Arial 16 bold', command=lambda: self.loggingsetup_set('-',7))
		self.starttime_cc_minute_minus.pack()
		self.starttime_cc_minute_minus.place(relx=0.33, rely=0.82, y=+15, height=30, width=30, anchor=NW)

		###Setup Breaktime Crisscross###	
		#Draw Label starttime
		self.breaktime_cc = Label(self.logging_setup, text='Pausen Kreuz.:', font='Arial 18 bold')
		self.breaktime_cc.pack()
		self.breaktime_cc.place(relx=0.55, rely=0.82, anchor=W)
		
		#Minute Label	
		self.breaktime_cc_minute=Label(self.logging_setup, textvariable=str(self.var_logging_setup_set[8]).zfill(2), font='Arial 16 bold')
		self.breaktime_cc_minute.pack()
		self.breaktime_cc_minute.place(relx=0.83, rely=0.82, anchor=CENTER)

		#Minute Label Info
		self.breaktime_cc_minute_info=Label(self.logging_setup, text='Minute', font='Arial 12 bold')
		self.breaktime_cc_minute_info.pack()
		self.breaktime_cc_minute_info.place(relx=0.83, rely=0.82, y=-20, anchor=CENTER)			
		
		#increment the minute
		self.breaktime_cc_minute_plus=Button(self.logging_setup, text='+', font='Arial 16 bold', command=lambda: self.loggingsetup_set('+',8))
		self.breaktime_cc_minute_plus.pack()
		self.breaktime_cc_minute_plus.place(relx=0.83, rely=0.82, y=+15, height=30, width=30, anchor=NE)
		
		#decrement the minute
		self.breaktime_cc_minute_minus=Button(self.logging_setup, text='-', font='Arial 16 bold', command=lambda: self.loggingsetup_set('-',8))
		self.breaktime_cc_minute_minus.pack()
		self.breaktime_cc_minute_minus.place(relx=0.83, rely=0.82, y=+15, height=30, width=30, anchor=NW)
...
class stopwatch_master_class():
	...
	def __init__(self, scoreboard_master, class_smbus):
		...
		if var_tempinfo['recovery_enable'] == 'true':
			...
			if self.game_count_main > pytrack.game_count:
				...
				if self.game_count_main > pytrack.game_count + pytrack.game_count_cc:
		...
		#print(pytrack)
		if pytrack != None:
			self.Home_Team_currnt=Label(self.operationMode_master, text=pytrack.getTeamNames(self.game_count_main)[0], font='Arial 16 bold')
			self.Home_Team_currnt.pack()
			self.Home_Team_currnt.place(relx=0, x=200, rely=0.20, anchor=CENTER)

			
			self.Guest_Team_currnt=Label(self.operationMode_master, text=pytrack.getTeamNames(self.game_count_main)[1], font='Arial 16 bold')
			self.Guest_Team_currnt.pack()
			self.Guest_Team_currnt.place(relx=1, x=-200, rely=0.20, anchor=CENTER)
	
			self.Home_Team_next=Label(self.operationMode_master, text=pytrack.getTeamNames(self.game_count_main+1)[0], font='Arial 12')
			self.Home_Team_next.pack()
			self.Home_Team_next.place(relx=0, x=200, rely=0.25, anchor=CENTER)
	
			self.Guest_Team_next=Label(self.operationMode_master, text=pytrack.getTeamNames(self.game_count_main+1)[1], font='Arial 12')
			self.Guest_Team_next.pack()
			self.Guest_Team_next.place(relx=1, x=-200, rely=0.25, anchor=CENTER)
	
			self.Gamemode_current=Label(self.operationMode_master, text='Gruppenspiele', font='Arial 16 bold')
			...
			self.Guest_Team_next_button=Button(self.operationMode_master, text='<', font='Arial 20', command=lambda: self.operationMode_master_set('-',5))
	        ...
	        ###Headerinfo###
		self.Header01=Label(self.operationMode_master, text='Stoppuhr', font='Arial 20 bold')
		self.Header01.pack()
		self.Header01.place(relx=0.5, y=50, anchor=CENTER)
		
		###Time Input###
		#Label for minutes, can change with beneath buttons
		self.minutes=Label(self.operationMode_master, text=str(var_interval_time[0]).zfill(2), font='Arial 20 bold')
		self.minutes.pack()
		self.minutes.place(relx=0.5, rely=0.5, x=-100, anchor=CENTER)
	
		#increment the minuts
		self.minutes_plus=Button(self.operationMode_master, text='+', font='Arial 20 bold', command=lambda: self.operationMode_master_set('+',0))
		...
		self.minutes_minus=Button(self.operationMode_master, text='-', font='Arial 20 bold', command=lambda: self.operationMode_master_set('-',0))
		...
		self.secondes=Label(self.operationMode_master, text=str(var_interval_time[1]).zfill(2), font='Arial 20 bold')
		self.secondes.pack()
		self.secondes.place(relx=0.5, x=30, rely=0.5, anchor=CENTER)
	
		#increment the seconds
		self.secondes_plus=Button(self.operationMode_master, text='+', font='Arial 20 bold', command=lambda: self.operationMode_master_set('+',1))
		self.secondes_plus.pack()
		self.secondes_plus.place(relx=0.5, rely=0.5, x=100, y=-5, height=40, width=40, anchor=S)
	
		#decrement the seconds
		self.secondes_minus=Button(self.operationMode_master, text='-', font='Arial 20 bold', command=lambda: self.operationMode_master_set('-',1))
		...
		self.steps=Label(self.operationMode_master, text='00 : 00', font='Arial 40 bold')
		self.steps.pack()
		...
		self.Home_Player_Info=Label(self.operationMode_master, text='Punkte Heimmannschaft', font='Arial 16 bold')
		self.Home_Player_Info.pack()
		self.Home_Player_Info.place(relx=0, x=100, rely=0.5, y=-80, anchor=CENTER)
	
		self.Home_Player=Label(self.operationMode_master, text='00', font='Arial 40 bold')
		self.Home_Player.pack()
		self.Home_Player.place(relx=0, x=150, rely=0.5, anchor=CENTER)
	
		#increment the score of home team
		self.Home_Player_plus=Button(self.operationMode_master, text='+', font='Arial 20 bold', command=lambda: self.operationMode_master_set('+',2))
		self.Home_Player_plus.pack()
		self.Home_Player_plus.place(relx=0, rely=0.5, x=250, y=-5, height=60, width=60, anchor=SE)
	
		#decrement the score of home team
		self.Home_Player_minus=Button(self.operationMode_master, text='-', font='Arial 20 bold', command=lambda: self.operationMode_master_set('-',2))
		self.Home_Player_minus.pack()
		self.Home_Player_minus.place(relx=0, rely=0.5, x=250, y=5, height=40, width=40, anchor=NE)
	
		#Label and InfoLabel for score of guest team, can change with beneath buttons
		self.Guest_Player_Info=Label(self.operationMode_master, text='Punkte Gastmanschaft', font='Arial 16 bold')
		self.Guest_Player_Info.pack()
		self.Guest_Player_Info.place(relx=1, x=-100, rely=0.5, y=-80, anchor=CENTER)
	
		self.Guest_Player=Label(self.operationMode_master, text='00', font='Arial 40 bold')
		self.Guest_Player.pack()
		self.Guest_Player.place(relx=1, x=-150, rely=0.5, anchor=CENTER)
	
		#increment the score of guest team
		self.Guest_Player_plus=Button(self.operationMode_master, text='+', font='Arial 20 bold', command=lambda: self.operationMode_master_set('+',3))
		self.Guest_Player_plus.pack()
		self.Guest_Player_plus.place(relx=1, x=-250, rely=0.5, y=-5, height=60, width=60, anchor=SW)
	
		#decrement the score of guest team
		self.Guest_Player_minus=Button(self.operationMode_master, text='-', font='Arial 20 bold', command=lambda: self.operationMode_master_set('-',3))
		self.Guest_Player_minus.pack()
		self.Guest_Player_minus.place(relx=1, x=-250, rely=0.5, y=5, height=40, width=40, anchor=NW)
	...
	def operationMode_master_set(self, toggle, position):
			if position == 0 and self.var_track_enable != '1' or position == 1 and self.var_track_enable != '1':
				...
				if position == 2:
					...
					#LED
					self.class_smbus.write_out(4, (int(str(self.var_track_value[position]).zfill(2)[0])))
					self.class_smbus.write_out(5, (int(str(self.var_track_value[position]).zfill(2)[1])))
	...
	def stopwatch_master_update(self):
		...
		if self.var_track_enable == '1' or self.extension == 'true':
			...
			self.class_smbus.write_out(0, (int(str(self.var_track_value[1]).zfill(2)[1])))
			#Seconds, first position ##:X#
			self.class_smbus.write_out(1, (int(str(self.var_track_value[1]).zfill(2)[0])))
			#Minutes, second position #X:##
			self.class_smbus.write_out(2, (int(str(self.var_track_value[0]).zfill(2)[1])))
			#Seconds, first position X#:##
			self.class_smbus.write_out(3, (int(str(self.var_track_value[0]).zfill(2)[0])))
	...
	def savedata(self):
		...
		if len(fieldsposition) > 2:
			factory.update("ute_"+str(str(self.game_count_main)+','+fieldsposition[2]+','+fieldsposition[3])+','+str(timedelta)+'_'+self.starttime_current_match+','+str(self.var_track_value[2])+','+str(self.var_track_value[3]))
		else:
			factory.update("ute_"+str(str(self.game_count_main)+','+str(timedelta)+'_'+self.starttime_current_match+','+str(self.var_track_value[2])+','+str(self.var_track_value[3])))
...
class countdown_master_class():
	...
	def __init__(self, scoreboard_master, class_smbus):
		...
		self.operationMode_master.takefocus=True
	        ...
	        ###Headerinfo###
		self.Header01=Label(self.operationMode_master, text='Countdown', font='Arial 20 bold')
		self.Header01.pack()
		self.Header01.place(relx=0.5, y=50, anchor=CENTER)
		...
		self.steps=Label(self.operationMode_master, text=str(var_interval_time[0]).zfill(2)+' : '+str(var_interval_time[1]).zfill(2), font='Arial 40 bold')
		self.steps.pack()
		self.steps.place(relx=0.5, rely=0.3, anchor=CENTER)
		...
		if pytrack != None:
			...
			self.Home_Team_next=Label(self.operationMode_master, text=pytrack.getTeamNames(self.game_count_main+1)[0], font='Arial 16')
			self.Home_Team_next.pack()
			self.Home_Team_next.place(relx=0, x=200, rely=0.25, anchor=CENTER)

			self.Guest_Team_next=Label(self.operationMode_master, text=pytrack.getTeamNames(self.game_count_main+1)[1], font='Arial 16')
			self.Guest_Team_next.pack()
			self.Guest_Team_next.place(relx=1, x=-200, rely=0.25, anchor=CENTER)
			...
			self.Home_Team_next_button=Button(self.operationMode_master, text='>', font='Arial 20', command=lambda: self.operationMode_master_set('+',4))
			self.Home_Team_next_button.pack()
			self.Home_Team_next_button.place(relx=1, x=-50, rely=0.25, y=20, anchor=CENTER)
	...
	def operationMode_master_set(self, toggle, position):
			if position == 0 and self.var_track_enable != '1' or position == 1 and self.var_track_enable != '1':
				...
				if position == 0:
					#Virtual
					self.minutes.config(text='%0.2d' %(self.var_track_set[position]))
					self.class_smbus.write_out(3, (int(str(self.var_track_set[position]).zfill(2)[0])))
					self.class_smbus.write_out(2, (int(str(self.var_track_set[position]).zfill(2)[1])))
				#Seconds update when setup the interval
				elif position == 1:
					#Virutal
					self.secondes.config(text='%0.2d' %(self.var_track_set[position]))
					#LED
					self.class_smbus.write_out(1, (int(str(self.var_track_set[position]).zfill(2)[0])))
					self.class_smbus.write_out(0, (int(str(self.var_track_set[position]).zfill(2)[1])))
	...
	def savedata(self):
		...
		print(fieldsposition)
		if len(fieldsposition) > 2:
			factory.update("ute_"+str(str(self.game_count_main)+','+fieldsposition[2]+','+fieldsposition[3])+','+str(self.var_track_value[2])+','+str(self.var_track_value[3]))
		else:
			factory.update("ute_"+str(str(self.game_count_main)+','+str(self.var_track_value[2])+','+str(self.var_track_value[3])))
		webserver.excel_init_value = str(pytrack.getScore(self.cur_gamemode,"string"))
